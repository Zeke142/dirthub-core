...
export default function HomePage() {
  ...
  return (
    <main className="font-sans px-4 py-8 max-w-3xl mx-auto bg-dirtbrown text-white min-h-screen transition-colors duration-300 dark:bg-black dark:text-white">
      <header className="text-center mb-12">
        <h1 className="text-4xl font-bold mb-2">DirtHub</h1>
        <p className="text-lg italic text-gray-300 dark:text-gray-400 mb-4">
          Turning waste into opportunity.
        </p>
        <p className="text-base text-gray-100 dark:text-gray-300">
        ...
        <div className="mt-6 flex justify-center space-x-4">
          ...
          <button className="bg-gray-200 text-black px-5 py-2 rounded hover:bg-gray-300 transition">
            Learn More
          </button>
        </div>
        <button
          onClick={() => setDarkMode(!darkMode)}
          className="mt-6 text-sm underline text-gray-200 dark:text-gray-400"
        >
      ...
      <section className="space-y-4 mb-12">
        <div className="bg-white bg-opacity-10 p-4 rounded shadow flex items-start gap-4">
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc list-inside space-y-1 text-gray-100 dark:text-gray-300">
      ...
      <footer className="text-center text-sm text-gray-300 mt-16">
